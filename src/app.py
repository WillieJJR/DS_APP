...
def show_popover(n_clicks_regress, n_clicks_class):
    if n_clicks_regress % 2 == 1:
        ...
        return dbc.Popover(
            ...
            * Multi-faceted algorithm that assigns a new data point to the class of the majority of its "K" nearest neighbors (determined beased on a distance metric), where "K" is a user-defined parameter.
...
def update_regression_graph(n_clicks_regress, n_clicks_linear, n_clicks_rf, jsonified_cleaned_data, feature_columns,
                            target_column):
...
def update_classification_graph(n_clicks_class, n_clicks_svm, n_clicks_rfclass, jsonified_cleaned_data, feature_columns,
                                target_column):
